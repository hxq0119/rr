<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:87:"C:\Users\Administrator\Desktop\PHP5.0\public/../application/admin\view\order\order.html";i:1544685958;}*/ ?>
<!DOCTYPE html>
<html>
<head lang="en">
    <meta charset="UTF-8">
    ...
    <div class="menu">
            <ul>
                ...
                <li class="now">
                    ...
                    <div class="child">
                        <a class="now" href="http://www.tp5.com/admin/Order.html">订单列表</a>
                        <a href="http://www.tp5.com/admin/Order/Repair.html">补考列表</a>
                    </div>
                </li>
                <li>
