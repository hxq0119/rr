<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:97:"C:\Users\Administrator\Desktop\PHP5.0\public/../application/admin\view\journalism\CourseList.html";i:1544685968;}*/ ?>
<!DOCTYPE html>
<html>
<head lang="en">
    <meta charset="UTF-8">
    <title>后台管理系统-题库</title>
            ...
            <ul>
                ...
                <li class="now">
                    ...
                    <div class="child">
                        ...
                        <a class="now" href="http://www.tp5.com/admin/Journalism/CourseList.html">题库</a>
...
<section class="ad_section">
    ...
    <div class="container-fluid">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">课程库</li>
        </ol>
        <div class="ad_content">
            <button id="addBtn" class="btn btn-default mb_15">添加题目</button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="#" id="form">
                    ...
                    <div class="form-group">
                        <input name="categoryName" type="text" class="form-control" placeholder="请输入课程题目">
                    </div>
                </form>
            </div>
