<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"C:\Users\HP\Desktop\PHP5.0\public/../application/admin\view\maintain\BasicSetup.html";i:1544774209;}*/ ?>
<!DOCTYPE html>
<html>
<head lang="en">
    <meta charset="UTF-8">
            ...
            <ul>
                ...
                <li class="now">
                    ...
                    <div class="child">
                        ...
                        <a class="now" href="http://www.tp5.com/admin/Maintain/BasicSetup.html">网页基本设置</a>
                    </div>
                </li>
            </ul>
        </div>
