<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"C:\Users\HP\Desktop\PHP5.0\public/../application/admin\view\customerservice\Study.html";i:1544775303;}*/ ?>
<!DOCTYPE html>
<html>
<head lang="en">
    <meta charset="UTF-8">
        ...
        <ul>
            <li class="now">
                ...
                <div class="child">
                    ...
                    <a class="now" href="http://www.tp5.com/admin/CustomerService/Study.html">课程学习</a>
                </div>
            </li>
            <li>
