<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:94:"C:\Users\Administrator\Desktop\PHP5.0\public/../application/admin\view\website\BasicSetup.html";i:1544688850;}*/ ?>
<!DOCTYPE html>
<html>
<head lang="en">
    <meta charset="UTF-8">
        ...
        <ul>
            ...
            <li class="now">
                ...
                <div class="child">
                    ...
                    <a class="now" href="http://www.tp5.com/admin/Website/BasicSetup.html">网页基本设置</a>
                </div>
            </li>
        </ul>
    </div>
