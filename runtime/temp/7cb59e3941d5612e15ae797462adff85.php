<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:92:"C:\Users\Administrator\Desktop\PHP5.0\public/../application/admin\view\journalism\Study.html";i:1544685976;}*/ ?>
<!DOCTYPE html>
<html>
<head lang="en">
    <meta charset="UTF-8">
            ...
            <ul>
                ...
                <li class="now">
                    ...
                    <div class="child">
                        ...
                        <a class="now" href="http://www.tp5.com/admin/Journalism/Study.html">课程学习</a>
                    </div>
                </li>
                <li>
