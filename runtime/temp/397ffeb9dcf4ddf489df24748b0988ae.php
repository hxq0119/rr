<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"C:\Users\HP\Desktop\PHP5.0\public/../application/admin\view\finance\Repair.html";i:1544755609;}*/ ?>
<!DOCTYPE html>
<html>
<head lang="en">
    <meta charset="UTF-8">
        ...
        <ul>
            <li class="now">
                ...
                <div class="child">
                    ...
                    <a class="now" href="http://www.tp5.com/admin/Finance/Repair.html">补考列表</a>
                </div>
            </li>
            <li>
