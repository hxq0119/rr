<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"D:\www\PHP5.0\public/../application/index\view\register\Register.html";i:1539250615;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <script src="http://www.ceshi.com/static/index/js/jquery.js"></script>
    <script src="http://www.ceshi.com/static/index/js/citySelect.js"></script>
    ...
    margin: 0 auto;
        ...
        body{
            height: 100%;
            background: url(http://www.ceshi.com/static/index/imags/timg.jpg) no-repeat;
...
<body>
    ...
    <div class="zucekuang">
        <form action="tijiao" method="post">
            ...
            <span>密码：</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="input1" name="password" type="password" id="oldPassword" maxlength="8" onKeyUp="value=value.replace(/[\W]/g,'')" placeholder="密码长度8位 数字+字母"><span class="span1" style="display:none;color:red;">此项不能为空</span><br>
            ...
            <span>身份证号码：</span><input class="input4" name="id_card" type="text" maxlength="18" onkeyup="this.value=this.value.replace(/\D/g,'')" placeholder="身份证号码"><span class="span4" style="display:none;color:red;">此项不能为空</span><br>
            ...
            <span>企业名称：</span>&nbsp;&nbsp;&nbsp;<input name="company" class="input6" type="text" placeholder="企业名称"><span class="span6" style="display:none;color:red;">此项不能为空</span><br>
                    <div class="info">
                                ...
                                <script class="resources library" src="http://www.ceshi.com/static/index/shengshiliandong/area.js" type="text/javascript"></script>
                ...
                <div class="anniu">
                        <input type="checkbox" style="outline:none; width:14px;"><span>我已阅读并接受</span>
        ...
        <div class="tiaokuan">
            <div id="xx">
                <img src="http://www.ceshi.com/static/index/imags/shanchu2.png" alt="">
            </div>
            <div class="neirong">
                <ul>
                    <li><h1>服务条款</h1></li>
...
<script>
    ...
    //             $(".span1").css("display","inline-block");
    //             return false;/*阻止表单提交*/
    //         }else if(pwassword!=ConfirmPassword){
    //             $(".span1").css("display","inline-block");
    //             return false;/*阻止表单提交*/
    //         }
