<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:89:"C:\Users\Administrator\Desktop\PHP5.0\public/../application/admin\view\user\Progress.html";i:1544685928;}*/ ?>
<!DOCTYPE html>
<html>
<head lang="en">
    <meta charset="UTF-8">
        ...
        <ul>
            ...
            <li class="now">
                ...
                <div class="child">
                    ...
                    <a class="now" href="http://www.tp5.com/admin/User/Progress.html">证书状态</a>
                </div>
            </li>
            <li>
