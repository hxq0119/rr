<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"C:\Users\HP\Desktop\PHP5.0\public/../application/index\view\index2\index.html";i:1541137824;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <link rel="icon" href="http://www.tp5.com/static/index/imags/icon.ico" type="image/png"/>
    <link type="text/css" rel="stylesheet" href="http://www.tp5.com/static/index/css/jquery.fullpage.css">
    <link type="text/css" rel="stylesheet" href="http://www.tp5.com/static/index/css/lunbo.css">
    <!-- <link rel="stylesheet" href="./js/luobo.js"> -->
    <link rel="stylesheet" href="http://www.tp5.com/static/index/css/donghua.css">
    <!-- <link type="text/css" rel="stylesheet" href="../jigsaw/jigsaw.css"> -->
    <link rel="stylesheet" href="http://www.tp5.com/static/index/font_dvzf0c1l41m/iconfont.css">
...
/* .container {
    ...
    .fenge{
      ...
      background: url(http://www.tp5.com/static/index/imags/lunbo6.png) no-repeat;
    }
</style>
</head>
<script>
...
<body id=fullpage"">
  ...
  <div class="slider" id="slider">
    <div class="slider-inner">
        <div class="item">
        <img class="img" style="background: url('http://www.tp5.com/static/index/imags/lunbo4.png');background-size:1519px;">
        </div>
        <div class="item">
        <img class="img" style="background: url('http://www.tp5.com/static/index/imags/lunbo6.png');background-size:1519px;">
        </div>
        <div class="item">
        <img class="img" style="background: url('http://www.tp5.com/static/index/imags/lunbo7.png');background-size:1519px;">
        </div>
  </div>
      <!-- 登陆组件开始 -->
      <div class="Land">
          ...
          <div class="table">
            <form action="index/doLogin2" method="post">
                <table>
                    ...
                    <tr>
                        <td><input name="username" class="shurukuang1" type="text" placeholder="请输入您的账号"></td>
                    </tr>
                    <tr style="height:20px"></tr>
                    <tr>
                        <td><input name="password" type="password" placeholder="请输入您的密码"></td>                        
                    </tr>
                    <tr style="height:20px"></tr>
                </table>
                <div class="anniu">
  ...
  <div class="Kecheng section s2">
    ...
    <div class="Curriculum w">
      <div class="Curriculum_1"><a href="#"><img src="http://www.tp5.com/static/index/imags/kecheng1.png" alt=""></a></div>
      <div class="Curriculum_2"><a href="#"><img src="http://www.tp5.com/static/index/imags/kecheng1.png" alt=""></a></div>
      <div class="Curriculum_3"><a href="#"><img src="http://www.tp5.com/static/index/imags/kecheng1.png" alt=""></a></div>
    </div>
    <div class="gengduo w">
      <a href="#">更多资讯</a>
    </div>
     ...
     <li  class="TeacherStrength_1 r">
      <div>
        <a href="#">
          <div class="ImagesOfPeople">
              <img src="http://www.tp5.com/static/index/imags/shizi3.png" alt="">
          </div>
      ...
      <li  class="TeacherStrength_2 r">
        <div>
          <a href="#">
              <div class="ImagesOfPeople">
                  <img src="http://www.tp5.com/static/index/imags/shizi1.png" alt="">
              </div>
      ...
      <li class="TeacherStrength_3 r">
        <div>
          <a href="#">
              <div class="ImagesOfPeople">
                  <img src="http://www.tp5.com/static/index/imags/shizi2.png" alt="">
              </div>
  ...
  <div class="xinwen section s4">
    ...
    <div class="Journalism w">
      <div class="Journalism_1 r">
        <a href="#">
          <img src="http://www.tp5.com/static/index/imags/xinwen1.png" alt="">
    ...
    <div class="gengduo_2 w">
        <a href="http://www.tp5.com/index/Journalism">更多资讯</a>
      </div>
  </div>
  <!-- 新闻结束 -->
  <!-- 底部开始 -->
...
<script>
    function jump(){
      window.open("http://www.tp5.com/index/Register");
    }
</script>
...
<!-- 滑动验证结束 -->
<!-- 动画js开始 -->
<script src="http://www.tp5.com/static/index/js/donghua.js">
