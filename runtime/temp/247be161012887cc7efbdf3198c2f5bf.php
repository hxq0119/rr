<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:97:"C:\Users\Administrator\Desktop\PHP5.0\public/../application/admin\view\curriculum\curriculum.html";i:1544685986;}*/ ?>
<!DOCTYPE html>
<html>
<head lang="en">
    <meta charset="UTF-8">
    <title>后台管理系统-新闻分类</title>
    ...
    <div class="menu">
            <ul>
                ...
                <li class="now">
                    ...
                    <div class="child" >
                        <a class="now" href="http://www.tp5.com/admin/Curriculum">新闻分类</a>
            ...
            <div class="modal-body">
                <form action="#" id="form">
                    <div class="form-group">
                        <input name="categoryName" type="text" class="form-control" placeholder="请输入新闻类称">
                    </div>
                </form>
            </div>
