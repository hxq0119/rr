<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:91:"C:\Users\Administrator\Desktop\PHP5.0\public/../application/admin\view\teacher\Teacher.html";i:1544685954;}*/ ?>
<!DOCTYPE html>
<html>
<head lang="en">
    <meta charset="UTF-8">
    ...
    <div class="menu">
            <ul>
                ...
                <li class="now">
                    ...
                    <div class="child">
                        <a class="now" href="http://www.tp5.com/admin/Teacher.html">名师列表</a>
                    </div>
                </li>
                <li>
