<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"C:\Users\HP\Desktop\PHP5.0\public/../application/index\view\index7\index.html";i:1539227249;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="zucekuang">
        <form action="tijiao" method="get">
            <span>账号： </span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="input" name="number" type="text" onKeyUp="value=value.replace(/[\W]/g,'')" placeholder="手机/邮箱"><span style="display:none;color:red;" class="span">此项不能为空</span><br>
            ...
            <span>企业名称：</span>&nbsp;&nbsp;&nbsp;<input name="enterprise" class="input6" type="text" placeholder="企业名称"><span class="span6" style="display:none;color:red;">此项不能为空</span><br>
                    <div class="info">
                                <div>
                        ...
                        <span>企业类型：</span>&nbsp;&nbsp;&nbsp;<select class="sex" name="TypeEnterprise" style="margin-top:20px;">
