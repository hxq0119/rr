<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:90:"C:\Users\Administrator\Desktop\PHP5.0\public/../application/admin\view\train\Training.html";i:1544685944;}*/ ?>
<!DOCTYPE html>
<html>
<head lang="en">
    <meta charset="UTF-8">
            ...
            <ul>
                ...
                <li class="now">
                    ...
                    <div class="child">
                        ...
                        <a class="now" href="http://www.tp5.com/admin/Train/Training.html">管理培训班</a>
                    </div>
                </li>
                <li>
        ...
        <div class="ad_content">
            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    <th>adfadsfa</th>
                    <th>adfadsfa</th>
                    <th><a href="http://www.tp5.com/admin/Train/TrainingSelective.html" class="btn btn-default mb_15">管理学员</a></th>
                    <th>adfadsfa</th>
                    <th>adfadsfa</th>                    
