<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"C:\Users\HP\Desktop\PHP5.0\public/../application/admin\view\supervise\Certificate.html";i:1544758385;}*/ ?>
<!DOCTYPE html>
<html>
<head lang="en">
    <meta charset="UTF-8">
    ...
    <div class="menu">
            <ul>
                ...
                <li class="now">
                    ...
                    <div class="child">
                        <a class="now" href="http://www.tp5.com/admin/Supervise/Certificate.html">用户进度</a>
                    </div>
                </li>
            </ul>
        </div>
